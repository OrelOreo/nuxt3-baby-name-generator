<script setup lang="ts">
    ...
    // Quand je clique sur l'un de boutons, ajoute class "option-active",
    // si clique sur le premier bouton ajoute class "option-left"
    // Si clique sur le dernier bouton ajoute class option-right
